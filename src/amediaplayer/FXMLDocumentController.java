        ...
        if (filePath != null) {
            ...
            mediaPlayer.currentTimeProperty().addListener(new ChangeListener<Duration>() {
                ...
                public void changed(ObservableValue<? extends Duration> observable, Duration oldValue, Duration newValue ){
                    ...
                    Double sliderLength = total.toSeconds();
                    seeSlider.setMin(0);
                    seeSlider.setMax(sliderLength);
                    seeSlider.setValue(newValue.toSeconds());
                    
                    Duration time;
                    time = mediaPlayer.getCurrentTime();
                    
                    long minutes = Math.round(time.toMinutes());
                    long secs = Math.round(time.toSeconds());
                    long hours = Math.round(time.toHours());
                    
                    
                    
//                    timeLength.setText(hours+":"+minutes+":"+secs);
                timeLength.setText(hours+":"+minutes);
